...
location = ["San Diego", "Arizona", "San Fransisco", "Simi Valley", "Seattle, Washington", "Texas", "Atlanta", "Los Angeles", "Orange County", "Burbank" ]
# keywords related with your job search
keywords = ["frontend", "react", "backend","javascript", "mongoDB", "python", "programming", "API", "Software Development"]
#job experience Level - ex:  ["Internship", "Entry level" , "Associate" , "Mid-Senior level" , "Director" , "Executive"]
experienceLevels = [ "Entry level","Internship", "Apprenticeship" ]
#job posted date - ex: ["Any Time", "Past Month" , "Past Week" , "Past 24 hours"] - select only one
datePosted = ["Past Week"]
#job type - ex:  ["Full-time", "Part-time" , "Contract" , "Temporary", "Volunteer", "Intership", "Other"]
jobType = ["Full-time", "Part-time" , "Contract","Internship", "Apprenticeship"]
